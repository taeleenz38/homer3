...
import Step1 from "./AcquireWithFiat/Step1";
import Step2 from "./AcquireWithFiat/Step2";
import Step3 from "./AcquireWithFiat/Step3";
import Step4 from "./AcquireWithFiat/Step4";
import { MobileStepper, Button } from "@mui/material";
import { useTheme } from "@mui/material/styles";
import "./AcquireWithFiat/Acquire.css";

interface AcquireFormProps {
  toggleForm: () => void; // Assuming toggleForm is a function with no arguments and returns void
}

const AcquireForm: React.FC<AcquireFormProps> = ({ toggleForm }) => {
